...
export default function Map({
  ...
  return (
    <MapContainer ref={containerRef}>
      <ReactMapGL
        mapStyle="mapbox://styles/suksham/claeb7cex002b14pgk3wzi2q5"
        mapboxApiAccessToken="pk.eyJ1Ijoic3Vrc2hhbSIsImEiOiJjbGFlYXZmdGQwNnB5M3ZwbWwzY2FsZzYzIn0.vmFjzswVAzlpC59R-jyPOw"
        {...viewport}
        width="100%"
        height="100%"
