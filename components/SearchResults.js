...
export default function SearchResults({
  ...
  var linktostripe = [
    "https://buy.stripe.com/test_aEUeYC8je5Vo1Zm3cc",
    "https://buy.stripe.com/test_7sI6s6gPK1F80Vi3cd",
    "https://buy.stripe.com/test_dR66s67fa3NgdI46oq",
    "https://buy.stripe.com/test_7sI6s6gPK1F80Vi3cd",
    "https://buy.stripe.com/test_7sI6s6gPK1F80Vi3cd",
    "https://buy.stripe.com/test_7sI6s6gPK1F80Vi3cd",
    "https://buy.stripe.com/test_7sI6s6gPK1F80Vi3cd",
        ...
        <div className="results">
          {results.map((item, index) => (
            <ResultCard
              ...
              key={index}
              linktostripe={linktostripe[index]}
            />
          ))}
        </div>
